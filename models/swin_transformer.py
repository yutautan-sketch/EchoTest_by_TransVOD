...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        # self.fpn = FeaturePyramidNetwork(in_channels_list=[256, 512, 1024],  out_channels=256)  # swin_b
        self.fpn = FeaturePyramidNetwork(in_channels_list=[192, 384, 768],  out_channels=256)  # swin_s
